...
import in.pulkitjain.expensetrackerapi.exceptions.ItemAlreadyExistsException;
...
public class UserServiceImpl implements UserService {
	...
	public User getLoggedInUser() {
		...
		return userRepository.findByEmail(email).orElseThrow(()->new UsernameNotFoundException("UserName not found for the email" + email));
	}
